function Manipulator_all_joints_nom_end_pos_task_space
...
%% Iterative LQR (iLQR)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
u = zeros(param.nbVarU*(param.nbData-1), 1); %I nitial control commands
...
%}
    ...
    for i = 1:param.nbData
        ...
        Q2 = param.Q2((i*Nf-Nf+1):i*Nf,(i*Nf-Nf+1):i*Nf);
        Hq(i*Nq-(Nq-1):i*Nq,i*Nq-(Nq-1):i*Nq) = Hq(i*Nq-(Nq-1):i*Nq,i*Nq-(Nq-1):i*Nq) + Jf'*Q2*Jf;
    end
