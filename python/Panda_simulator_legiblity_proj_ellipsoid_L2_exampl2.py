...
traj_weights =np.ones(len(traj))*1.5
#traj_weights =np.linspace(4, 0, len(traj))
...
runningCostModel.addCost("gripperPose", goalTrackingCost, 110)
...
runningCostModel.addCost("obstacleAvoidance", obsAvoidCost, 0.2)
